...
async function runPipeline(input) {
  ...
  if (identityHit) {
    ...
    return { response: identityResponse, mode: effectiveMode, intents: [{ type: 'identity' }], provider: 'shortcut', source: 'shortcut', shortcut: 'identity' };
  }
  ...
  if (psiEmaExplainHit) {
    ...
    return { response: explanation, mode: effectiveMode, intents: [{ type: 'psi-ema-explain' }], provider: 'shortcut', source: 'shortcut', shortcut: 'psi-ema-explain' };
  }
